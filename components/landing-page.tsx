...
const Landing = () => {
  return (
    <div className="bg-gray-100 min-h-screen">
        ...
        <div className="bg-white flex flex-row items-center justify-around mx-auto ">
            ...
            <div className=' flex-1 overflow-hidden'><Image src={idb_logo} alt="IDB Logo"  objectFit="contain" className='mx-auto'/></div>
